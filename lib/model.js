import {germanRequirement} from './insights.js?v=15';
...
export function matchJob(job, profile = defaultProfile) {
  ...
  if(german.status !== 'match') flags.push((german.label.startsWith('German requirement')?'':'German requirement: ') + german.label + '. ' + german.detail);
