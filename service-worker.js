const CACHE = 'job-notebook-v18';
const ASSETS = ['/', '/index.html', '/styles.css?v=18', '/app.js?v=18', '/lib/model.js?v=18', '/lib/insights.js', '/manifest.json', '/icons/icon.svg', '/icons/icon-192.png', '/icons/icon-512.png'];
