const CACHE = 'job-notebook-v17';
const ASSETS = ['/', '/index.html', '/styles.css?v=17', '/app.js?v=17', '/lib/model.js?v=17', '/lib/insights.js', '/manifest.json', '/icons/icon.svg', '/icons/icon-192.png', '/icons/icon-512.png'];
