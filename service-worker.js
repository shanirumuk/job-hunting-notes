const CACHE = 'job-notebook-v20';
const ASSETS = ['/', '/index.html', '/styles.css?v=20', '/app.js?v=20', '/lib/model.js?v=20', '/lib/insights.js', '/lib/summaries.js', '/manifest.json', '/icons/icon.svg', '/icons/icon-192.png', '/icons/icon-512.png'];
