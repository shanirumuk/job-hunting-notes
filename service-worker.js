const CACHE = 'job-notebook-v19';
const ASSETS = ['/', '/index.html', '/styles.css?v=19', '/app.js?v=19', '/lib/model.js?v=19', '/lib/insights.js', '/lib/summaries.js', '/manifest.json', '/icons/icon.svg', '/icons/icon-192.png', '/icons/icon-512.png'];
