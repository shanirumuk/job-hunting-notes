const CACHE = 'job-notebook-v11';
const ASSETS = ['/', '/index.html', '/styles.css?v=11', '/app.js?v=11', '/lib/model.js?v=11', '/manifest.json', '/icons/icon.svg', '/icons/icon-192.png', '/icons/icon-512.png'];
