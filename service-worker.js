const CACHE = 'job-notebook-v12';
const ASSETS = ['/', '/index.html', '/styles.css?v=12', '/app.js?v=12', '/lib/model.js?v=12', '/manifest.json', '/icons/icon.svg', '/icons/icon-192.png', '/icons/icon-512.png'];
