const CACHE = 'job-notebook-v14';
const ASSETS = ['/', '/index.html', '/styles.css?v=14', '/app.js?v=14', '/lib/model.js?v=14', '/manifest.json', '/icons/icon.svg', '/icons/icon-192.png', '/icons/icon-512.png'];
