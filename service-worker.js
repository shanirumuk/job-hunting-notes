const CACHE = 'job-notebook-v15';
const ASSETS = ['/', '/index.html', '/styles.css?v=15', '/app.js?v=15', '/lib/model.js?v=15', '/lib/insights.js?v=15', '/manifest.json', '/icons/icon.svg', '/icons/icon-192.png', '/icons/icon-512.png'];
