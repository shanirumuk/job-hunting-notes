const CACHE = 'job-notebook-v6';
const ASSETS = ['/', '/index.html', '/styles.css?v=6', '/app.js?v=6', '/lib/model.js?v=6', '/manifest.json', '/icons/icon.svg', '/icons/icon-192.png', '/icons/icon-512.png'];
