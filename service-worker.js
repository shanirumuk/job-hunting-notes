const CACHE = 'job-notebook-v10';
const ASSETS = ['/', '/index.html', '/styles.css?v=10', '/app.js?v=10', '/lib/model.js?v=8', '/manifest.json', '/icons/icon.svg', '/icons/icon-192.png', '/icons/icon-512.png'];
