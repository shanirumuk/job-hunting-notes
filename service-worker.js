const CACHE = 'job-notebook-v16';
const ASSETS = ['/', '/index.html', '/styles.css?v=16', '/app.js?v=16', '/lib/model.js?v=16', '/lib/insights.js', '/manifest.json', '/icons/icon.svg', '/icons/icon-192.png', '/icons/icon-512.png'];
