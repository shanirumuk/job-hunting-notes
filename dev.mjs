...
http.createServer(async (req, res) => {
  ...
  const allowed = /^\/(?:index\.html|practice-application\.html|styles\.css|app\.js|service-worker\.js|manifest\.json|lib\/(?:model|insights|summaries|device-crypto|device-store|device-sync)\.js|icons\/[a-z0-9.-]+)$/;
